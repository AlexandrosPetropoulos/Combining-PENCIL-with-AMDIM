...
from utils_amdim import flatten, random_locs_2d, Flatten
...
class Model(nn.Module):
    ...
    def forward(self, x1, x2, class_only=False):
        ...
        if class_only:
            ...
            ##################################################################################
            # lgt_glb_lin = self.evaluator(rkhs_1)
            # res_dict['class'] = lgt_glb_lin
        ...
        res_dict['class'] = [lgt_glb_mlp, lgt_glb_lin]
        ##################################################################################
        # lgt_glb_lin = self.evaluator(ftr_1=torch.cat([r1_x1, r1_x2]))#lgt_glb_mlp, lgt_glb_lin = self.evaluator(ftr_1=torch.cat([r1_x1, r1_x2]))
        # res_dict['class'] = [lgt_glb_lin]
